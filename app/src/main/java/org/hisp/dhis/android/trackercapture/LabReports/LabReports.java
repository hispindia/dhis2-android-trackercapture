...
//                    LabReport labreport = new LabReport();
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        String serum_scrumtyphusigm= c.get(22).toString();
