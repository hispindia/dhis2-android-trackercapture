...
public class Apex_org_wise extends Activity {
    ...
    public void addListenerOnButton() {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Apex_org_wise.this, org.hisp.dhis.android.trackercapture.LabReports.ApexLab.class);
                intent.putExtra("orgid", org_id);
                intent.putExtra("orgname", name);
                Apex_org_wise.this.startActivity(intent);
            }
