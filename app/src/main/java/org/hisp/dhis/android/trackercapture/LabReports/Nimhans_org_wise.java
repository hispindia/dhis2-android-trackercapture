...
public class Nimhans_org_wise extends Activity {
    ...
    public void addListenerOnButton() {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Nimhans_org_wise.this, NimhansLab.class);
                intent.putExtra("orgid", org_id);
                intent.putExtra("orgname", name);
                Nimhans_org_wise.this.startActivity(intent);
            }
